...
// 	Hint: At each step, among the vertices which weren’t yet checked and 
// 	for which a path from vertex 1 was found, take the one which has the shortest path, 
// 	from vertex 1 to it, yet found.
// ]
// -----------------------------------------------------------------------------------------
